 ...
 */
@Composable
fun LoginScreen(modifier: Modifier = Modifier, viewModel: AuthViewModel = viewModel(), navController: NavHostController){
    ...
    Column (
        ...
        Button(onClick = {
            ...
            modifier = Modifier.fillMaxWidth()
                .height(60.dp)) {
            Text(if(isLoading) "Logging" else "Login", fontSize = 22.sp)
        }
    }
}
